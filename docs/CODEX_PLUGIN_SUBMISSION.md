...
4. Upload the generated `dist/codex/taskplanner-codex-skills-2.0.1` skill tree, add its starter prompts and reviewer cases, and select supported availability.
