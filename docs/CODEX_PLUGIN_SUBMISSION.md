...
2. Run `npm run release:check` from the verified `v2.1.12` source. The release check packages and validates both the public plugin root and its upload ZIP.
...
4. Upload `dist/codex/taskplanner-codex-skills-2.1.12.zip`, add its starter prompts and reviewer cases, and select supported availability.
